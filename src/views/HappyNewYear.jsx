...
const HappyNewYear = () => {
    ...
    const { id } = useParams()
    const expectedId = 'la-famille-mbebi-vous-souhaite-une-very-bonne-et-heureuse-annee-2026'
    console.log(id)
    ...
    return (
        <div className="bg-white">
            <Helmet>
                <title>La famille Mbebi vous souhaite bonnes fêtes de fin d'année...Lire la suite</title>
                {/* <meta name='description' content='Beginner friendly page for learning React Helmet.' /> */}
            </Helmet>
            <div className='p-6 h-screen w-full bg-[#3394d8]/10'>
                <img className='fixed top-0 right-0 z-20 h-1/4' src='/flower-top-right.png' alt="Vite logo" />
                <img className='fixed bottom-0 left-0 z-20 h-1/4' src='/flower-bottom-left.png' alt="Vite logo" />
                <img className='fixed top-0 left-0 h-1/4 opacity-80' src='/flower-top-left.png' alt="Vite logo" />
                <img className='fixed bottom-0 right-0 h-1/4 opacity-60' src='/flower-bottom-right.png' alt="Vite logo" />
                <div className="relative h-full border-4 border-[#778da5] rounded">
                    ...
                    <div className="relative h-full overflow-y-scroll p-6 bg-white/60">
                        ...
                        <div className="italic flex flex-col gap-3 text-slate-500 py-14">
                            <h2 className='text-4xl font-bold text-sky-400 my-4 style-henielle'>La famille Mbebi <br /> vous souhaite une très bonne et heureuse année 2026</h2>
                            <p className="text-slate-700">
                                Remplie de bénédictions, de joie et de paix. Que l'année nouvelle soit pour vous et vos proches une période de croissance, de succès et de rapprochement avec Dieu.
                            </p>
                            ...
                            <img className='relative h-14 mx-auto' src='/flower-center.png' alt="Vite logo" />
                            <p className="">
                            ...
                            <img className='relative h-14 mx-auto my-4' src='/flower-center.png' alt="Vite logo" />
