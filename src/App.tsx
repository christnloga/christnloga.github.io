...
function App() {
  ...
  let services_fr = [
    "Design de produits (UI/UX)",
    "Développement web",
    "Développement d'applications",
    "MVP & Support de startup",
    "Consulting technique",
    "Identité de marque technologique",
    "Formation",
  ];
  ...
  return (
    <div className="flex flex-col justify-between overflow-x-hidden">
      <img
        src="/floor.png"
        className="fixed left-0 bottom-0 saturate-0 mix-blend-screen opacity-10 object-scale-down"
        alt=""
      />
      {/* <Helmet>
      ...
      <header className="relative max-w-[calc(100vw-50px)] lg:max-w-[320px] mx-auto flex h-[calc(100vh-150px)] flex-col grow w-full overflow-hidden rounded-b-3xl rounded-t-3xl mt-6">
        ...
        <div className="relative flex flex-col items-start z-10 px-6 mt-auto">
          <RevealElement>
            <p className="text-styled text-white text-4xl ml-5 font-bold">
              {t("happy")}
            </p>
          </RevealElement>
          <RevealElement>
            <h2
              className={
                "text-[100px] text-white font-bold -mt-10 -ml-2 text-shadow uppercase"
              }
            >
              {t("new")}
            </h2>
          ...
          <RevealElement>
            <h2 className="text-[60px] text-white -mt-16 ml-3 text-shadow uppercase">
              {t("year")}
            </h2>
          </RevealElement>
        </div>
              ...
              <RevealElement>
                <div className="relative z-10 flex p-3 hover:scale-105 bg-zinc-800 items-start border border-sky-300/20 rounded-xl shadow-2xl duration-150 shadow-sky-300/40">
                  ...
                  <div className="relative z-10">
                    <p className="text-2xl text-left font-bold text-slate-100 ml-5">
                      {t("openForBusiness")}
                    </p>
                  </div>
                </div>
            ...
            <RevealElement>
              <div className="flex items-center gap-4 mt-2">
                <a
                  ...
                  className="flex hover:brightness-110 active:brightness-125 transition-all duration-150 shrink-0 size-10 rounded-full mb-11 bg-zinc-700 border-2 border-zinc-600 overflow-hidden"
                >
